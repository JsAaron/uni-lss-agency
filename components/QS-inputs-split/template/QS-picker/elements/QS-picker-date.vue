		...
		>
			<picker-view-column v-if="setObj.dateMode >= 1">
				<view
					...
					:class="(value[0] || 0) === picker_index ? 'selectColor' : 'defaultColor'"
					v-for="(picker_item, picker_index) in years"
					:key="picker_index"
				>
					{{ picker_item }}年
				</view>
			...
			<picker-view-column v-if="setObj.dateMode >= 2">
				<view
					class="flex_row_c_c pickerDefault"
					:class="(value[1] || 0) === picker_index ? 'selectColor' : 'defaultColor'"
					v-for="(picker_item, picker_index) in months"
					:key="picker_index"
				>
					{{ picker_item }}月
				</view>
			...
			<picker-view-column v-if="setObj.dateMode >= 3">
				<view
					class="flex_row_c_c pickerDefault"
					:class="(value[2] || 0) === picker_index ? 'selectColor' : 'defaultColor'"
					v-for="(picker_item, picker_index) in days"
					:key="picker_index"
				>
					{{ picker_item }}日
				</view>
			...
			<picker-view-column v-if="setObj.dateMode >= 4">
				<view
					class="flex_row_c_c pickerDefault"
					:class="(value[3] || 0) === picker_index ? 'selectColor' : 'defaultColor'"
					v-for="(picker_item, picker_index) in hours"
					:key="picker_index"
				>
					{{ picker_item }}时
				</view>
			...
			<picker-view-column v-if="setObj.dateMode >= 5">
				<view
					class="flex_row_c_c pickerDefault"
					:class="(value[4] || 0) === picker_index ? 'selectColor' : 'defaultColor'"
					v-for="(picker_item, picker_index) in ms"
					:key="picker_index"
				>
					{{ picker_item }}分
				</view>
			...
			<picker-view-column v-if="setObj.dateMode >= 6">
				<view
					class="flex_row_c_c pickerDefault"
					:class="(value[5] || 0) === picker_index ? 'selectColor' : 'defaultColor'"
					v-for="(picker_item, picker_index) in ms"
					:key="picker_index"
				>
					{{ picker_item }}秒
...
export default {
	...
	methods: {
		init() {
			...
			years = QSPicker.countYears(
				setObj.startYear || new Date().getFullYear() - 5,
				setObj.endYear || new Date().getFullYear() + 5
			);
			...
			if (dm >= 1) {
				if (compareY) value.push(years.length - 1);
				else
